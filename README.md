...
contact@digrecords.fr; the interview credit (World Records, Volume Two, Iain Wakefield, 2024). Still an orange
placeholder in square brackets: the legal notice (company, SIRET, host), and the portrait photo on the story page. Edit the HTML directly; the copy is inline next to its
